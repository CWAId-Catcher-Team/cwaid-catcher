...
# Install protoc with doing: sudo apt-get install protobuf-compiler
...
tail +17c < ./exports/$latest_day/export.bin | protoc --decode SAP.external.exposurenotification.TemporaryExposureKeyExport --proto_path=./proto/ ./proto/temporary_exposure_key_export.proto > ./exports/$latest_day/tek
