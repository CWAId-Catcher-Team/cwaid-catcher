/*
  ...
  list all files in root http://esp32fs.local/list?dir=/
*/
#include <WiFi.h>
...
// WRITE WLAN CREDENTIALS HERE
const char* ssid = "";
const char* password = ""; //DO NOT UPLOAD WITH PASSWORD SET!!!
